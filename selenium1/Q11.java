...
public class Q11 {
	...
	public static void FillTextBox() {
		driver.findElement(By.xpath("//input[@placeholder='First Name']")).sendKeys("chhotu");
		...
		driver.findElement(By.xpath("//input[@type='email']")).sendKeys("chhotu1.@tothenew.com");
		driver.findElement(By.xpath("//input[@type='tel']")).sendKeys("9304536384");
		driver.findElement(By.xpath("//input[@id='firstpassword']")).sendKeys("ck123");
		driver.findElement(By.xpath("//input[@id='secondpassword']")).sendKeys("ck123");
	}
